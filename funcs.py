...
def create_game_info(url, season_id, season_gamecount, game_type):
    ...
    return [game_id, season_id, date, game_type]
...
def change_dtypes(df, num_columns):
    ...
    df[num_columns[0]].replace(to_replace='-99', value='Did Not Play', inplace=True)
